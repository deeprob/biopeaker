...
#SBATCH -o /data7/deepro/pipelines/biopeaker/slurm/logs/out_mlt_run.log # TODO: set slurm output file
#SBATCH -e /data7/deepro/pipelines/biopeaker/slurm/logs/err_mlt_run.log # TODO: set slurm input file
...
save_dir="/data7/deepro/pipelines/biopeaker/data/tmp/resnet_1000_mlt"

python $peaker_path $dataset_path $genome_fasta $save_dir --pilot --task_names label
