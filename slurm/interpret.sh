...
save_dir="/data6/deepro/computational_pipelines/dl_setup/data/linear"
homer_dir="/data5/deepro/starrseq/papers/results/4_ml_classification_fragment_category/data/homer/motif_features.csv.gz"

python $peaker_path linear $dataset_path homer $genome_fasta $save_dir --test --homer_saved $homer_dir
